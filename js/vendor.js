! function (t, e) {
  ...
  var ue = function () {
      function t(e, n, u, i) {
        for (Lt(this, t), this.value = e, this.cursorPos = n, this.oldValue = u, this.oldSelection = i; this.value.slice(0, this.startChangePos) !== this.oldValue.slice(0, this.startChangePos);) --this.oldSelection.start
      }
      return Ut(t, [{
        key: "startChangePos",
        get: function () {
      ...
      return Ut(t, [{
        ...
        value: function (e) {
          if (String(e)) {
            ...
            if (e instanceof re) u ? n.extend(e.toString()) : this.chunks.push(e);
